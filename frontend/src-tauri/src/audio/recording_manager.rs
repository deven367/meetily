...
impl RecordingManager {
    ...
    pub async fn start_recording(
        ...
        info!("Starting recording manager (auto_save: {}, save_folder: {:?})", auto_save, save_folder);
    ...
    pub async fn start_recording_with_defaults_and_auto_save(&mut self, auto_save: bool, save_folder: PathBuf) -> Result<mpsc::UnboundedReceiver<AudioChunk>> {
        #[cfg(target_os = "macos")]
        {
            ...
            self.start_recording(microphone_device, system_device, auto_save, save_folder).await
        }
